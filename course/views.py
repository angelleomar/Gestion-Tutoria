...
def program_view(request):
    ...
    return render(request, 'course/tutor_list.html', {
...
def tutor_add(request):
    ...
    return render(request, 'course/tutor_add.html', {
...
def program_detail(request, pk):
    ...
    return render(request, 'course/alumnos_tutor.html', {
        'title': program.title,
...
def documentos(request, slug):
    ...
    return render(request, 'course/documentos.html', {
        'title': course.title,
        'course': course,
        'files': files,
