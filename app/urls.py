...
from .views import (
    home_view, noti_add, edit_post, delete_post, 
    session_list_view, session_add_view, session_update_view, session_delete_view, 
    gen_pdf_view, semester_add_view, semester_update_view, semester_delete_view,
    dashboard_view
) 
...
urlpatterns = [
    ...
    path('add_item/', noti_add, name='add_item'),
    ...
    path('semester/', gen_pdf_view, name="gen_pdf"),
